...
class WeatherSdkModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
...
@ReactMethod
fun fetchWeatherByCityName(city: String, promise: Promise) {
...
@ReactMethod
fun fetchWeatherByCoordinates(lat: Double, lon: Double, promise: Promise) {
